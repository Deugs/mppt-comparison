...
failure mode than "stuck at a local maximum," and is exactly the kind of
result CLAUDE.md's Known Risks anticipated: reporting Q-learning's
held-out performance honestly, rather than only its training-distribution
numbers, surfaces a real, qualitatively distinct weakness rather than a
...
Fig.~\ref{fig:computational-burden} shows directly.
...
distribution never including multi-module shading -- see
Section~\ref{sec:conclusion} for the limitations this implies.
