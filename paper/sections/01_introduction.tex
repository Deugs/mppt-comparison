...
space of tracking strategies; the seminal comparison in this same journal,
\cite{esram2007comparison}, surveyed 19 such techniques, but as a narrative
survey rather than a paradigm-structured, statistically-validated
comparison, and predates both learning-based and model-based nonlinear
control as MPPT approaches entirely. In the two decades since, the
comparative literature built around that design space has instead
converged on two recurring, increasingly saturated
