...
a boost converter under 11 test conditions (9 single-module scenarios plus
3 complex partial-shading patterns), each evaluated over 50 Monte Carlo
...
relevance given fuzzy logic's measured $\sim$100$\times$ per-step
...
\input{sections/03_pv_model}
\input{sections/04_converter_model}
\input{sections/05_algorithms}
\input{sections/06_scenarios}
